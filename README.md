...
[🌐 View My Portfolio](https://swagatiportfolio.netlify.app/) •
...
| Project | Description |
|---|---|
| 🤖 **EMI Predict AI** | Machine learning application for EMI prediction and financial analysis. |
| 🕳️ **Pothole Detection** | Computer vision project for detecting potholes using images. |
| 📊 **HR Analytics** | Data analytics project focused on HR and employee insights. |
| 🔐 **Steganography** | Python project for securely hiding information in digital media. |
| 🎬 **Online Movie Ticket Booking** | Web-based application for online movie ticket booking. |
| 💼 **Job Portal** | Web-based platform for job seekers and recruitment. |
